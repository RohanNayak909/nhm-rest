 ...
 * nirmalya.aatithya.restmodule.user.dao.RestProcessMasterDao; import
 ...
 *//**
	 ...
	 *//*
		 ...
		 * @RestController
		 * 
		 * @RequestMapping(value = "user") public class RestProcessMasterController {
		 * 
		 * @Autowired RestProcessMasterDao processDao;
		 * 
		 ...
		 * }) public ResponseEntity<JsonResponse<Object>> restAddProcess(@RequestBody
		 * RestProcessMasterModel processMaster) {
		 * logger.info("Method : restAddNewProcess starts");
		 * logger.info("Method : restAddNewProcess endss"); return
		 * processDao.addProcess(processMaster); }
		 * 
		 * 
		 * returns all Process
		 *
		 ...
		 * public ResponseEntity<JsonResponse<List<RestProcessMasterModel>>>
		 * getAllProcess(
		 * 
		 * @RequestBody DataTableRequest request) {
		 * logger.info("Method : getAllProcess starts");
		 * logger.info("Method : getAllProcess endss"); return
		 * processDao.getAllProcess(request); }
		 * 
		 * 
		 ...
		 * public ResponseEntity<JsonResponse<RestProcessMasterModel>>
		 * viewProcess(@RequestParam("id") String id) {
		 * logger.info("Method : viewProcess starts");
		 * logger.info("Method : viewProcess ends"); return processDao.viewProcess(id);
		 * }
		 * 
		 * 
		 ...
		 * public ResponseEntity<JsonResponse<Object>> deleteProcess(@RequestParam
		 ...
		 * logger.info("Method : restGetProcess ends"); return
		 * processDao.restGetProcess(); }
		 * 
		 * }
		 */