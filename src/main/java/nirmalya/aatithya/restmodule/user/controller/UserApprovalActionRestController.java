 ...
 * nirmalya.aatithya.restmodule.user.dao.UserApprovalActionDao; import
 * nirmalya.aatithya.restmodule.user.model.UserApprovalActionModel;
 * 
 * @RestController
 * 
 * @RequestMapping("user/") public class UserApprovalActionRestController {
 * 
 * Logger logger =
 * LoggerFactory.getLogger(UserApprovalActionRestController.class);
 * 
 * @Autowired UserApprovalActionDao userApprovalActionDao;
 * 
 * 
 * for All approval action
 * 
 * @RequestMapping(value = "getAllApprovals", method = { RequestMethod.POST })
 * public ResponseEntity<JsonResponse<List<UserApprovalActionModel>>>
 * getAllApprovals(
 * 
 ...
 * public ResponseEntity<JsonResponse<Object>> restAddApproval(@RequestBody
 * UserApprovalActionModel approval) {
 ...
 * public ResponseEntity<JsonResponse<UserApprovalActionModel>>
 * getApprovalById(@RequestParam String id) {
 ...
 * public ResponseEntity<JsonResponse<Object>> deleteApprovalById(@RequestParam
 * String id,
 * 
