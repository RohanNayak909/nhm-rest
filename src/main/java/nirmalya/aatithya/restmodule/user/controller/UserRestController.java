 ...
 * nirmalya.aatithya.restmodule.user.dao.UserDao; import
 ...
 * 
 * logger.info("Method : getCountryName ends"); return
 * userDao.getCountryName("getCountryName"); }
 * 
 * 
 * Get state
 *
 ...
 * public ResponseEntity<JsonResponse<List<DropDownModel>>>
 * getStateName1(@RequestParam String id) {
 ...
 * public ResponseEntity<JsonResponse<List<DropDownModel>>>
 * getDistName1(@RequestParam String id) {
...
/*
 * 
 * @RequestMapping(value = "rest-get-user-type-list", method = {
 * RequestMethod.GET }) public List<DropDownModel> getUserType() {
 * logger.info("Method : RESTMODULE UserRestController getUserRole starts");
 * logger.info("Method : RESTMODULE UserRestController getUserRole ends");
 ...
 * public ResponseEntity<JsonResponse<Object>> addUserData(@RequestBody
 * UserModel form) {
 * logger.info("Method : RESTMODULE UserRestController addUserData starts");
 * logger.info("Method : RESTMODULE UserRestController addUserData end"); return
 * userDao.addUserDataList(form); }
 * 
 *//**
	 * VIEW USER
	 *
 ...
 * public ResponseEntity<JsonResponse<List<UserModel>>> getAllUsers(@RequestBody
 * DataTableRequest request) {
 * logger.info("Method : RESTMODULE UserRestController getAllUsers starts");
 * logger.info("Method : RESTMODULE UserRestController getAllUsers end"); return
 * userDao.getAllUserList(request); }
 * 
 *//**
	 * EDIT USER
	 *
 ...
 * public ResponseEntity<JsonResponse<UserModel>> getUserById(@RequestParam
 * String id) {
 * logger.info("Method : RESTMODULE UserRestController getUserById starts");
 * logger.info("Method : RESTMODULE UserRestController getUserById end"); return
 * userDao.getUserByIdData(id); }
 * 
 * 
 *//**
	 * EDIT USER
 ...
 * public ResponseEntity<JsonResponse<UserModel>> restGetModelById(@RequestParam
 * String id) {
 ...
 * public ResponseEntity<JsonResponse<Object>> restDeleteUser(@RequestParam
 * String id) {
 ...
 * }) public ResponseEntity<JsonResponse<List<DropDownModel>>>
 * getStateByCntId(@RequestParam String proCat) {
 * logger.info("Method : RestController getStateByCntId starts");
 * 
 * logger.info("Method : RestController getStateByCntId ends"); return
 * userDao.getStateByCntId(proCat); }
 * 
 * 
 *//**
	 * ONCHANGE STATE on Country
 ...
 * }) public ResponseEntity<JsonResponse<List<DropDownModel>>>
 * getStateListByCatId(@RequestParam String proCat) {
 * logger.info("Method : RestController getStateListByCatId starts");
 * 
 * logger.info("Method : RestController getStateListByCatId ends"); return
 * userDao.getStateListByCatId(proCat); }
 * 
 * 
 * 
 * 
...
/*
 * 
 * @RequestMapping(value = "restGetDistrictListById", method = {
 * RequestMethod.GET }) public ResponseEntity<JsonResponse<List<DropDownModel>>>
 * getDIstrictListByCatId(@RequestParam String proCat) {
 * logger.info("Method : RestController getDIstrictListByCatId starts");
 * 
 * logger.info("Method : RestController getDIstrictListByCatId ends"); return
 * userDao.getDistListById(proCat); }
 *//**
	 * VIEW STAFF USER LIST PDF
	 *
	 *//*
		 * @RequestMapping(value = "restGetAllFoodOrderDataPdf", method = {
		 * RequestMethod.POST }) public ResponseEntity<JsonResponse<List<UserModel>>>
		 * restGetAllFoodOrderDataPdf(
		 * 
		 * @RequestBody DataTableRequest request) { logger.
		 * info("Method : RESTMODULE UserRestController restGetAllFoodOrderDataPdf starts"
		 * ); logger.
		 * info("Method : RESTMODULE UserRestController restGetAllFoodOrderDataPdf end"
