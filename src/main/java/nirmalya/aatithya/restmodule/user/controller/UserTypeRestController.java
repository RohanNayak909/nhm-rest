 ...
 * nirmalya.aatithya.restmodule.user.dao.UserTypeDao; import
 * nirmalya.aatithya.restmodule.user.model.UserTypeModel;
 * 
 *//**
 ...
 * @RestController
 * 
 * @RequestMapping(value = "user/") public class UserTypeRestController { Logger
 * logger = LoggerFactory.getLogger(UserTypeRestController.class);
 * 
 ...
 * public ResponseEntity<JsonResponse<Object>> addUserType(@RequestBody
 * UserTypeModel form) { logger.info("Method : addUserType starts");
 * 
 ...
 * deleteUserTypeById(@RequestParam String id,@RequestParam String createdBy) {
 ...
 *//**
	 ...
	 *//*
		 ...
		 * public ResponseEntity<JsonResponse<UserTypeModel>> getFloorById(@RequestParam
		 * String id) {
		 * 
